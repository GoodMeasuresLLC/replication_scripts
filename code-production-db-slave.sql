-- code-production db-slave
CREATE EXTENSION pglogical;
set pglogical.conflict_resolution = 'keep_local';
SELECT pglogical.create_node(
node_name := 'db-slave',
  dsn :=  'host=172.16.1.51 port=5432 dbname=code_production user=postgres'
         );
...
provider_dsn :=  'host=172.16.1.79 port=5432 dbname=code_production user=postgres',
